...
const config = {
  title: 'GameLift Documentation',
  tagline: 'GameLift Documentation',
  url: 'https://gamelift.eeldev.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/eeldev_icon.png',
  organizationName: 'eeldev-ue4', // Usually your GitHub org/user name.
  projectName: 'doc.gamelift', // Usually your repo name.
      ...
      navbar: {
        ...
        items: [ 
          ...
          */
          ...
          { href: 'https://www.unrealengine.com/marketplace/en-US/profile/eeldev', label: 'Unreal Marketplace' },
